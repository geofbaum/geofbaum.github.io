var currentTime = new Date();
		...
		var goes = {
			'Shortwave Infrared': tdswir,
			'Longwave Infrared': tdlwir,
			'Water_Vapor': tdwv,
			'Visible': tdvis
		};
		...
		map.on('overlayremove', function (eventLayer) {
			if (eventLayer.name === 'Shortwave Infrared') {
				this.removeControl(legend1);
			} else if (eventLayer.name === 'Longwave Infrared') {
				this.removeControl(legend2);
			} else if (eventLayer.name === 'Water_Vapor') {
