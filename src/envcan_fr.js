		...
		legend1.onAdd = function(map) {
			var src1 = "http://geo.weather.gc.ca/geomet//?LANG=Fr%26SERVICE=WMS%26VERSION=1.1.1%26REQUEST=GetLegendGraphic%26STYLE=TEMPERATURE%26LAYER=HRDPS.CONTINENTAL_TT%26format=image/png"
		...
		legend2.onAdd = function(map) {
			var src2 = "http://geo.weather.gc.ca/geomet//?LANG=Fr%26SERVICE=WMS%26VERSION=1.1.1%26REQUEST=GetLegendGraphic%26STYLE=WINDARROWKMH%26LAYER=HRDPS.CONTINENTAL_UU%26format=image/png"
			var div = L.DomUtil.create('div', 'info legend');
			div.innerHTML +=
		...
		legend3.onAdd = function(map) {
			var src3 = "http://geo.weather.gc.ca/geomet//?LANG=Fr%26SERVICE=WMS%26VERSION=1.1.1%26REQUEST=GetLegendGraphic%26STYLE=DEWPOINTDEP%26LAYER=HRDPS.CONTINENTAL_ES%26format=image/png"
			var div = L.DomUtil.create('div', 'info legend');
			div.innerHTML +=
		...
		legend4.onAdd = function(map) {
			var src4 = "http://geo.weather.gc.ca/geomet//?LANG=Fr%26SERVICE=WMS%26VERSION=1.1.1%26REQUEST=GetLegendGraphic%26STYLE=PRECIPMM%26LAYER=HRDPS.CONTINENTAL_PR%26format=image/png"
			var div = L.DomUtil.create('div', 'info legend');
			div.innerHTML +=
		...
		var envcan = {
			...
			'Quantité de précipitations (mm pour 6h)': tdPrecip,
			'Flèches de vent en km/h': tdWind,
		};
			
		L.control.layers(basemaps, envcan).addTo(map);
		
		envcan.Température.addTo(map);
		...
		map.on('overlayremove', function (eventLayer) {
			...
			} else if (eventLayer.name === 'Flèches de vent en km/h') {
